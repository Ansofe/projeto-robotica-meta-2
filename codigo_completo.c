...
int main()
{
    ...
    else
    {
        ...
        do
        {
            ...
            printf("use a letra z para parar de movimentar o referente servo da base/n");
            do{
            scanf("%i",&n_servo);
            if(n_servo!=0||n_servo!=1||n_servo!=2||n_servo!=3||n_servo!=4||n_servo!=5)
            {
                printf("numero invalido, digite outro\n");
            }
            }while(n_servo!=0||n_servo!=1||n_servo!=2||n_servo!=3||n_servo!=4||n_servo!=5);
            do
            {
                tecla = getchar();
                if(n_servo == 0)
                {
                    if(tecla !=100&&tecla!=97)
                        {
                        printf("tecla errada, digite a ou s para movimentar");
                        }
                    else{
                    if(tecla == 100)
                    {
